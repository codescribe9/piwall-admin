...
@Component({
  selector: 'ngx-volume-dragger',
  templateUrl: './volume-dragger.component.html',
  styleUrls: ['./volume-dragger.component.scss'],
})
export class VolumeDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = VolumeDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
